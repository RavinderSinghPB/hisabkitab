...
# from . import views
from .views import add_item, category_data, date_catg_wise_data,date_wise_data, overview,count_itm,update_item,cunt_itm_price,date_max_itm_price,latest_date,Particular_date_data,filter_catg,user_registrations,user_data,add_members#delete_collection
urlpatterns = [
